	...
	<div class="container-fluid">
	  <div class="wrapper">
        ...
        <g:hasErrors bean="${form}">
			<div role="alert"style="background-color:#FFF3F3; color:red; border: solid thin; padding: 10px;" clas="material-icons"><i class="material-icons" style="color:red; font-size:15px;">warning</i>
